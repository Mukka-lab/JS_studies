// Object
// Todo objeto é criado com o construtor Object, e por isso herda as propriedades e métodos de seu protótipo.
...
const carro = {
    ...
    buzinar(){
        return `${this.marca} ${this.ano} buzinou!`;
    },
};
...
console.log(BMW.init('BMW').acelerar());
*/
...
// Object.getPrototypeOf() - Object.is()
